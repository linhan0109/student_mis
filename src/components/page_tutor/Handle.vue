...
<script>
   var array = JSON.parse(localStorage.getItem("handle")|| '[]');
...
    console.log(array)
    ...
    methods: {
      ...
      ok:function(index){
        ...
        console.log(index)
         $.ajax({
               url:'http://127.0.0.1:5000/examine',
             
                data:JSON.stringify([{"ocpno":index+1,"action":"success"}]),
               type:'post',
               dataType:'json',
       ...
       console.log(index)
         $.ajax({
               url:'http://127.0.0.1:5000/examine',
                ...
                data:JSON.stringify([{"ocpno":index+1, "action":"fail"}]),
               type:'post',
               dataType:'json',
               success:function(data){
               alert('正常');
