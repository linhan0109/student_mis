...
<div class="classroom_mes">
  ...
  <!-- 上方选择栏 -->
   <div class="text1" style="margin-top:15px">
      ...
      <el-form-item style="width:100px" >
          <el-select v-model="formInline.day" placeholder="周几">
      ...
      <el-form-item style="width:200px">
          ...
          <el-option label="第一节" value="first"></el-option>
          <el-option label="第二节" value="second"></el-option>
          <el-option label="第三节" value="third"></el-option>
          <el-option label="第四节" value="fourth"></el-option>
          <el-option label="第五节" value="fifth"></el-option>
          <el-option label="第六节" value="sixth"></el-option>
          <el-option label="第七节" value="seventh"></el-option>
          </el-select>
      </el-form-item>
      <el-form-item>
...
<script>
  ...
  var array1 = JSON.parse(localStorage.getItem("classroom_mes1")|| '[]');//data
...
              success:function(data){ //后端返回的json数据（此处data为json对象）
                ...
                array1 = JSON.parse(localStorage.getItem("class_mes1") || '[]')
                console.log
